...
//				initialCorruptSeedNode.GetComponent<MeshRenderer> ().material.color = Color.red;
				...
				player.currentFunds -= (player.currentFunds/8);
				initialCorruptSeedNode.GetComponent<Node> ().illicitFunds += (player.currentFunds/8);
